...
var Gateway = /*#__PURE__*/function (_Vector) {
  ...
  _createClass(Gateway, [{
    ...
    value: function getStyle() {
      return _objectSpread({}, _get(_getPrototypeOf(Gateway.prototype), "getStyle", this).call(this));
    }
  }, {
    ...
    value: function render() {
      var _this$getObjectAttrib = this.getObjectAttributes(),
          ...
          z = _this$getObjectAttrib.z,
          name = _this$getObjectAttrib.name,
          macId = _this$getObjectAttrib.macId,
          gatewayClusterType = _this$getObjectAttrib.gatewayClusterType,
          clusterId = _this$getObjectAttrib.clusterId,
